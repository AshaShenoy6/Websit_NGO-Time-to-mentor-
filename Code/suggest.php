    ...
    <! ---- END NAVBAR ---->
        ...
        <div class="container" style="padding-top: 50px;">
            <section class="box4" data-aos="zoom-in-up">
                <form method="POST" style="color:white;align-content: center">
            ...
            $(document).ready(function() {
                $(window).scroll(function() { // check if scroll event happened
                    if ($(document).scrollTop() > 50) { // check if user scrolled more than 50 from top of the browser window
                        $(".ftco-navbar-light").css("background-color", ""); // if yes, then change the color of class "navbar-fixed-top" to white (#f8f8f8)
                    } else {
                        $(".ftco-navbar-light").css("background-color", "transparent"); // if not, change it back to transparent
                    }
                });
            });
